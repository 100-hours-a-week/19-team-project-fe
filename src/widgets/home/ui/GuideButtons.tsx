...
const expertItems = [
  {
    id: 'expert-1',
    title: '채팅 알림 기능 추가',
    body: '채팅 요청 및 새 메시지를 실시간 알림으로 바로 확인할 수 있습니다.',
    note: '요청 수락/응답 시점 파악이 쉬워집니다.',
  },
  {
    id: 'expert-2',
    title: '커피챗 운영 안내',
    body: '자유형 채팅으로 이력서/공고 링크 없이도 대화할 수 있습니다.',
    note: '참여자 모두 채팅 종료 가능하며, 레포트는 생성되지 않습니다.',
  },
  {
    id: 'expert-3',
    title: '피드백 운영 안내',
    body: '지원자 이력서와 채용 공고를 기준으로 구체적 피드백을 제공합니다.',
    note: '이력서/공고 링크 첨부가 필수이며, 종료 권한은 현직자에게 있습니다.',
  },
  {
    id: 'expert-4',
    title: '레포트 생성 조건',
    body: '피드백 종료 후 현직자 설문 작성이 완료되어야 레포트가 생성됩니다.',
    note: '설문 미제출 시 레포트는 제공되지 않습니다.',
  },
];
