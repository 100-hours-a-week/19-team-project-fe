      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            boxShadow:
              'rgba(0, 0, 0, 0.6) calc((var(--pointer-from-left) * 6px) - 2px) calc((var(--pointer-from-top) * 10px) - 4px) 16px -4px',
        ...
        >
          ...
          >
            ...
            >
              <div className="absolute top-5 flex w-full flex-col">
                <h3
                  className="m-0 text-base font-semibold"
                  style={{
                    backgroundImage: 'linear-gradient(to bottom, #fff, #a7a7ff)',
